                    ...
                    <div className="col">
                        <section>
                            ...
                            <ul className="nav flex-column">
                                <li className="nav-item"><NavLink to='/about' href="/about.html" className="nav-link">О магазине</NavLink></li>
                                <li className="nav-item"><NavLink to='/catalog' href="/catalog.html" className="nav-link">Каталог</NavLink></li>
                                <li className="nav-item"><NavLink to='/contacts' href="/contacts.html" className="nav-link">Контакты</NavLink></li>
                            </ul>
                        </section>
                    </div>
                    <div className="col">
